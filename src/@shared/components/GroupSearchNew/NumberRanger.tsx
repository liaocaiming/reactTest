  ...
  public render (){
    ...
    return (
      <span className='fe-numberRanger'>
        <InputNumber placeholder='请输入' value={searchParams[key1]} onChange={onChange({ dataIndex: key1})}/>
        <i className='line'/>
        <InputNumber placeholder='请输入' value={searchParams[key2]} onChange={onChange({ dataIndex: key2 || key1})}/>
      </span>
    )
  }
