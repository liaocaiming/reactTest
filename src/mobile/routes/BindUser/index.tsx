...
const APP = (props: IProps) => {
  ...
  return (
    <div className='bind-account'>
      <div className='skip-btn-container'><span className='skip-btn'>跳过</span></div>
      ...
      <div className='form-container'>
        ...
        <div className="form">
          <Input label='API密钥' containerClassName='margin_bttom_10' value={api} onChange={apiOnchange}></Input>
          <Input label='密钥' value={secret} onChange={secretOnchange}></Input>
        </div>
        <div className='submit-btn' onClick={goNext}>下一步</div>
      </div>
    </div>
  );
}
